...
<head>
  ...
  <link href="assets/assets/css/paper-dashboard.css?v=2.0.1" rel="stylesheet" />
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel" style="height: 100vh;">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">METI LAMITASARI</a>
          </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            <h3 class="description">Selamat Datang di TOTE BAG</h3>
          </div>
        </div>
      </div>
  ...
  <script src="assets/assets/js/paper-dashboard.min.js?v=2.0.1" type="text/javascript"></script>
</body>
