  ...
  <main id="main">
            ...
            <div class="">
              <form action="{{url('pesanan')}}" method="post">
                ...
                <div class="form-group">
                  <font color="red"><label for="nama">Nama Produk</label></font>
                  <input type="text" class="form-control" id="nama" name="nama" value="{{$produk->nama}}" readonly="">
                </div>
                <div class="form-group">
                   <font color="red"><label for="harga">Harga Produk</label></font>
                  <input type="text" class="form-control" id="harga" name="harga" value="{{$produk->harga}}" readonly="">
                </div>
                <div class="form-group">
                   <font color="red"><label for="jumlah">Jumlah Pesanan</label></font>
                  <input type="number" min="1" class="form-control" id="jumlah" name="jumlah">
                </div>

                                 <font color="red"><label for="" class="control-label">Provinsi</label></font>
                            ...
                            <font color="red"> <label for="" class="control-label">Ibukota</label></font>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Contact adalah untuk mempermudah anda mengunjungi toko kami dengan cepat dan benar</p>
        </div>
      </div>
